...
// ─────────────────────────────────────────────────────────────────────────────
//  ROOT — StatefulWidget so we reload on every visit
// ─────────────────────────────────────────────────────────────────────────────
...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  void initState() {
    super.initState();
    // Load fresh Firestore data on first open
              ...
              slivers: [
                SliverToBoxAdapter(
                  child: _TopBar(
                    ...
                    ).then((_) => prov.loadProfile()), // ← reload after edit
                  ),
                ),
                SliverToBoxAdapter(
                ...
                SliverToBoxAdapter(
                  child: _ActionsGrid(p: p, prov: prov), // ← pass prov
                ),
...
// ─────────────────────────────────────────────────────────────────────────────
//  QUICK ACTIONS GRID
//  NOTE: now accepts `prov` so Change Password can trigger loadProfile()
// ─────────────────────────────────────────────────────────────────────────────
        ...
        children: [
          ...
          Expanded(
            child: _ActionCard(
              ...
              ).then((_) => prov.loadProfile()), // ← reload after pwd change
            ),
          ),
        ],
      ),
...
// ─────────────────────────────────────────────────────────────────────────────
//  EDIT SHEET (bottom sheet — kept for reference, EditProfileScreen is used)
// ─────────────────────────────────────────────────────────────────────────────

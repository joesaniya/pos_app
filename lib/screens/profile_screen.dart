          ...
          SafeArea(
            child: CustomScrollView(
              ...
              slivers: [
                ...
                SliverToBoxAdapter(child: _OrgCard(p: p, prov: prov)),
                SliverToBoxAdapter(child: _SectionHead(title: 'ACCOUNT TIMELINE')),
                ...
                SliverToBoxAdapter(child: _ActionsGrid(p: p, prov: prov)),
                if (p.recentActivity.isNotEmpty) ...[
                  SliverToBoxAdapter(child: _SectionHead(title: 'RECENT ACTIVITY')),
                  SliverToBoxAdapter(child: _ActivityCard(p: p, prov: prov)),
                ],
...
class _StatsStrip extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Padding(
      ...
      child: Row(
        children: [
          _StatBox(value: '${s.ordersToday}',    label: 'Orders\nToday',    color: _K.royal),
          const SizedBox(width: 8),
          _StatBox(value: '${s.tablesManaged}',  label: 'Tables\nManaged',  color: _K.teal),
          const SizedBox(width: 8),
          _StatBox(
          ...
          const SizedBox(width: 8),
          _StatBox(value: '${s.shiftsThisWeek}/6', label: 'Shifts\nWeek', color: _K.violet),
        ],
      ),
    );
  }
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [
          BoxShadow(color: _K.royal.withOpacity(0.06), blurRadius: 24, offset: const Offset(0, 8)),
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        ...
        if (!isLast)
          Container(height: 1, color: _K.line, margin: const EdgeInsets.only(left: 69)),
      ],
    );
  }
}
          ...
          _FieldRow(
            ...
            trailing: GestureDetector(
              ...
              child: Container(
                ...
                child: const Icon(Icons.copy_outlined, size: 14, color: _K.royal),
              ),
            ),
          ),
        ],
    ...
    return _LuxCard(
      child: Column(
        children: [
          ...
          // ── Created By row — reads from prov (no extra Firestore call) ──
...
// ─────────────────────────────────────────────────────────────────────────────
//  CREATED BY ROW
//  Displays creatorName + role badge from the user's own document fields
// ─────────────────────────────────────────────────────────────────────────────
class _CreatedByRow extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (prov.creatorName.isNotEmpty) {
      ...
      // Fallback: read directly from UserProfile if provider hasn't set yet
          ...
          child: Row(
            children: [
              ...
              Container(
                ...
                child: const Icon(Icons.person_add_outlined, size: 18, color: _K.violet),
              ),
              const SizedBox(width: 13),
...
class _RoleBadge extends StatelessWidget {
  ...
  Color get _color {
    switch (role.toLowerCase()) {
      ...
      case 'manager': return const Color(0xFF1A56DB);
      case 'cashier': return const Color(0xFF0D9488);
      case 'waiter':
      case 'server':  return const Color(0xFF10B981);
      case 'chef':    return const Color(0xFFF59E0B);
      default:        return _K.royal;
    }
  }
          ...
          children: [
            ...
            Container(
              ...
              decoration: BoxDecoration(
                ...
                color: color,
                boxShadow: [
                  BoxShadow(color: color.withOpacity(0.45), blurRadius: 6, spreadRadius: 1),
                ],
              ),
            ),
          ],
          ...
          Padding(
            ...
            child: Column(
              children: [
                Row(
                  children: [
                    _PBlock(emoji: '🧾', label: 'Total Orders\nHandled', value: _fmt(s.totalOrdersAllTime), color: _K.royal),
                    const SizedBox(width: 10),
                    _PBlock(emoji: '💵', label: 'Avg Order\nValue', value: '₹${s.avgOrderValue.toStringAsFixed(0)}', color: _K.green),
                  ],
                ),
                const SizedBox(height: 10),
                Row(
                  children: [
                    _PBlock(emoji: '🪑', label: 'Tables\nManaged', value: '${s.tablesManaged}', color: _K.teal),
                    const SizedBox(width: 10),
                    _PBlock(emoji: '⏱️', label: 'Shifts This\nWeek', value: '${s.shiftsThisWeek} / 6', color: _K.violet),
                  ],
                ),
              ],
            ),
...
class _PBlock extends StatelessWidget {
  ...
  final Color color;
  const _PBlock({required this.emoji, required this.label, required this.value, required this.color});
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          boxShadow: [
            BoxShadow(color: color.withOpacity(0.10), blurRadius: 16, offset: const Offset(0, 6)),
          ],
        ),
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            Container(
              ...
              decoration: BoxDecoration(
                ...
                borderRadius: BorderRadius.circular(14),
                boxShadow: [
                  BoxShadow(color: color.withOpacity(0.30), blurRadius: 8, offset: const Offset(0, 4)),
                ],
              ),
            ...
            Text(
              sub,
              style: const TextStyle(fontSize: 11, color: _K.muted, fontWeight: FontWeight.w500),
            ),
            const SizedBox(height: 12),
            Row(
              children: [
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 2),
                    Text(sub, style: const TextStyle(fontSize: 11, color: _K.muted)),
                  ],
                ),
              ),
              Text(
        ...
        if (!isLast)
          Container(height: 1, color: _K.line, margin: const EdgeInsets.only(left: 68)),
      ],
    );
  }
}
      ...
      child: GestureDetector(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            ...
            boxShadow: [
              BoxShadow(color: _K.rose.withOpacity(0.06), blurRadius: 12, offset: const Offset(0, 4)),
            ],
          ),
          child: Row(
            ...
            children: [
              Container(
                ...
                child: const Icon(Icons.logout_rounded, color: _K.rose, size: 15),
              ),
              const SizedBox(width: 10),
              const Text(
                'Sign Out',
                style: TextStyle(color: _K.rose, fontSize: 15, fontWeight: FontWeight.w800),
              ),
            ],
          ),
        ),
          ...
          child: Column(
            ...
            children: [
              Container(
                ...
                child: const Icon(Icons.logout_rounded, color: _K.rose, size: 26),
              ),
              const SizedBox(height: 16),
              const Text(
                'Sign out?',
                style: TextStyle(fontSize: 20, fontWeight: FontWeight.w900, color: _K.ink),
              ),
...
// ─────────────────────────────────────────────────────────────────────────────
//  SCREEN  — passes prov to OrgCard so creator info is accessible
// ─────────────────────────────────────────────────────────────────────────────
class _Screen extends StatelessWidget {
  final ProfileProvider prov;
  final UserProfile p;
          ...
          SafeArea(
            child: CustomScrollView(
              ...
              slivers: [
                ...
                SliverToBoxAdapter(child: _PersonalCard(p: p)),
                SliverToBoxAdapter(child: _SectionHead(title: 'ORGANISATION')),
                // ↓ prov passed so OrgCard can read creatorName / creatorRole
                SliverToBoxAdapter(
    ...
    return _LuxCard(
      child: Column(
        children: [
          ...
          // Created By — shows name + role pill (fetched from Firestore)
          _CreatedByRow(p: p, prov: prov),
        ],
      ),
    );
...
// ─────────────────────────────────────────────────────────────────────────────
//  CREATED BY ROW
//  Shows a shimmer while loading, then creator name + role badge
// ─────────────────────────────────────────────────────────────────────────────
class _CreatedByRow extends StatelessWidget {
  final UserProfile p;
  final ProfileProvider prov;
  ...
  Widget build(BuildContext context) {
    log(
      'id===>${p.createdBy}creatorName="${prov.creatorName}" and creatorRole="${prov.creatorRole}"',
    );
    final bool isSelf = p.createdBy == p.id;
        ...
        Padding(
          ...
          child: Row(
            children: [
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    // While creator doc is being fetched → shimmer bar
                    if (prov.isLoadingCreator)
                      Container(
                        height: 14,
                        width: 130,
                        decoration: BoxDecoration(
                      ...
                      Text(
                        prov.creatorName.isNotEmpty
                            ? isSelf
                                  ? '${prov.creatorName} (You)'
                                  : prov.creatorName
                            : p.createdBy.isEmpty
                            ? '—'
                            : 'Unknown',
              ...
              // Role badge — visible once creator info is loaded
              if (!prov.isLoadingCreator && prov.creatorRole.isNotEmpty)
                _RoleBadge(role: prov.creatorRole),
            ],
          ),
        ),
      ],
...
// ─────────────────────────────────────────────────────────────────────────────
//  ROLE BADGE  — colour-coded pill showing the creator's role
// ─────────────────────────────────────────────────────────────────────────────
class _RoleBadge extends StatelessWidget {
  final String role;
  const _RoleBadge({required this.role});

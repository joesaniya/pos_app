...
class _SplashScreenState extends State<SplashScreen>
  ...
  Future<void> _initializeApp() async {
    ...
    if (!mounted) return;
    log(
      'Splash initialization complete. isFirstLaunch=${splashProvider.isFirstLaunch}, isLoggedIn=${splashProvider.isLoggedIn}',
    );
    if (splashProvider.isFirstLaunch) {
      log('First launch detected. Navigating to onboarding.');

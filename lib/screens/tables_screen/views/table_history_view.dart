...
class HistoryCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final outTime = item.actualCheckOut != null ? _fmtTime(item.actualCheckOut!) : null;
    final dur = item.actualCheckOut != null
        ? item.actualCheckOut!.difference(item.reservedFor).inMinutes
        : null;
